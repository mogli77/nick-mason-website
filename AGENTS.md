...
This file provides guidance to Codex and other AI coding agents when working with code in this repository. See CLAUDE.md for the canonical version — this file mirrors it.
...
The navigation has a dynamic color-switching system implemented via inline script in `index.html`:
...
1. **CSS Custom Properties** - All design tokens (colors, fonts, spacing)
